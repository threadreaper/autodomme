"""
    ...
    A very simple media player ready for you to customize.  Uses the VLC player to playback local files and YouTube streams.  
    You will need to install the Python bindings for VLC as well as the VLC player itself.
